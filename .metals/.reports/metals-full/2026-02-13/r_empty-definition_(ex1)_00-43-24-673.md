error id: file://<WORKSPACE>/ex01_data_retrieval/src/main/scala/load.scala:_empty_/MinIOLoader.uploadParquetFileToMinIO().
file://<WORKSPACE>/ex01_data_retrieval/src/main/scala/load.scala
empty definition using pc, found symbol in pc: 
empty definition using semanticdb

found definition using fallback; symbol uploadParquetFileToMinIO
offset: 912
...
object MinIOLoader {
  ...
  def main(args: Array[String]): Unit = {
    ...
    try {
      MinIOClient.readParquetFromMinIO()
      MinIOClient.uploa@@dParquetFileToMinIO(url, bucketNAme, dest)
    } catch {
      case ex: Exception =>

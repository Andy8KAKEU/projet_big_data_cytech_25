error id: file://<WORKSPACE>/ex05_ml_prediction_service/src/main/scala/TipPredictionModel.scala:local1
file://<WORKSPACE>/ex05_ml_prediction_service/src/main/scala/TipPredictionModel.scala
empty definition using pc, found symbol in pc: 
empty definition using semanticdb

found definition using fallback; symbol PipelineModel
offset: 643
uri: file://<WORKSPACE>/ex05_ml_prediction_service/src/main/scala/TipPredictionModel.scala
text:
```scala
package ml
...
object TipPredictionModel {
  ...
  /** Entraîne un modèle de classification Random Forest pour prédire les
    ...
    */
  def trainModel(trainingData: DataFrame): Pipeline@@Model = {
    ...
    try {
      ...
      featureNames
        ...
        .foreach { case (name, importance) =>
          println(f"      - $name%-20s: ${importance * 100}%.2f%%")
        }
    } catch {
      case _: Exception =>
